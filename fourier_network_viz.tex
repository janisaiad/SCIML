...
\begin{tikzpicture}
  ...
  % Second network
  \node[conv,right=4cm of conv2](conv3){\rotatebox{90}{Conv}};
  \node[plate,right=0.2cm of conv3](plate3){};
  \node[block,right=0.2cm of plate3,yshift=-2.5cm](resblock6){\rotatebox{90}{ResBlock}};
  \node[block,above=0.1cm of resblock6](resblock7){\rotatebox{90}{ResBlock}};
  \node[block,above=0.1cm of resblock7](resblock8){\rotatebox{90}{ResBlock}};
  \node[block,right=0.2cm of resblock6](x4){\rotatebox{90}{(X4)}};
  \node[block,above=0.1cm of x4](x5){\rotatebox{90}{(X3)}};
  \node[block,above=0.1cm of x5](x6){\rotatebox{90}{(X2)}};
  \node[plate,right=0.2cm of x5](plate4){};
  \node[block,right=0.6cm of x5](resblock9){\rotatebox{90}{ResBlock4}};
  \node[block,right=2cm of resblock9](resblock10){\rotatebox{90}{ResBlock5}};
  \node[conv,right=0.2cm of resblock10](conv4){\rotatebox{90}{Conv}};
  \draw [-,link] ([xshift=0.2cm,yshift=0.2cm]resblock9.east) -- ([yshift=0.2cm]resblock10.west);
  \draw [-triangle 60,link] ([xshift=0.2cm,yshift=0.2cm]conv4.east) -- ([xshift=1.5cm,yshift=0.2cm]conv4.east);

  % Connection between networks
  \draw [-triangle 60,link] ([xshift=1.5cm,yshift=0.2cm]conv2.east) -- ([yshift=0.2cm]conv3.west);
\end{tikzpicture}
